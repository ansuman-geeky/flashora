  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text className="text-xs text-text-tertiary dark:text-text-secondary-dark mb-4">
          Last updated: May 2026
        </Text>

        <Text className="text-base font-semibold text-text-primary dark:text-text-primary-dark mt-2 mb-1.5">
          1. 100% Client-Side Processing
        </Text>
        <Text className="text-sm text-text-secondary dark:text-text-secondary-dark leading-5 mb-4">
        ...
        <Text className="text-sm text-text-secondary dark:text-text-secondary-dark leading-5 mb-2">
